        ...
        <div className={scss.content}>
          ...
          <div className={scss.buttonPanel}>
            <div className={scss.languageSwitcher}>
              <button suppressHydrationWarning className={scss.button}>
                Кырг
              </button>
              <button suppressHydrationWarning className={scss.button}>
                Рус
            ...
            <div className={scss.iconGroup}>
              <button suppressHydrationWarning className={scss.Sightbutton}>
                <Image src={Eye} alt="Eye" width={20} height={20} />
              </button>
              <button suppressHydrationWarning className={scss.Searchbutton}>
